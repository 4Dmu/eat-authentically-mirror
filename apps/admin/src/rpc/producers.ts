...
const rpc = {
  edit: authenticatedActionClient
  ...
  editContact: authenticatedActionClient
  ...
  editLocation: authenticatedActionClient
  ...
  editCertifications: authenticatedActionClient
  ...
  editCommodities: authenticatedActionClient
  ...
  addCommodityAndAssociate: authenticatedActionClient
  ...
  requestUploadUrls: authenticatedActionClient
    .input(
      type({
        producerId: "string",
        ...
        for (let i = 0; i < imageItemParams.length; i++) {
          ...
          if (uploadUrlGeneratorCloudflareResponseBody.success === true) {
            ...
            pending.push({
              ...
              pendingAssetKey:
                uploadUrlGeneratorCloudflareResponseBody.result.id,
  ...
  requestVideoUploadUrl: authenticatedActionClient
  ...
  confirmPengingUpload: authenticatedActionClient
    .input(type({ producerId: "string" }))
    ...
    .action(async ({ ctx: { session }, input: { producerId } }) => {
      ...
      try {
        ...
        const coverUrl =
          media.find((r) => r.role === "cover")?.asset.url ??
          media[0].asset.url;
  ...
  confirmPendingVideoUpload: authenticatedActionClient
    .input(type({ producerId: "string" }))
  ...
  deleteVideo: authenticatedActionClient
    .input(type({ producerId: "string" }))
  ...
  updateExistingImages: authenticatedActionClient
    .input(
      type({
        producerId: "string",
