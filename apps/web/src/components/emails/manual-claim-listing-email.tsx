        ...
        <Container className="p-5">
          <Row>
            <Column className="">
              ...
              />
              <Heading as="h1">Claim {props.producer.name}</Heading>
              <Heading as="h5">
                This is an automated message from{" "}
                <Link href={env.SITE_URL}>EatAuthentically</Link>
              </Heading>
              <Text>
                You recently made a request to claim the producer{" "}
                {props.producer.name} on eatauthentically.app, you selected to
                manual option to prove your owndership of this producer.
              </Text>
              <Text>
                Please reply to this email with an explanation of your
                relationship with {props.producer.name} and your proof of
                owndership.
              </Text>
            </Column>
          </Row>
...
ManualClaimListingEmail.PreviewProps = {
  producer: {
