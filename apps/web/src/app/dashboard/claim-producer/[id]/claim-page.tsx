                    ...
                    <div className="flex flex-col gap-2 text-left">
                      <div className="flex gap-2">
                        ...
                        <Label>
                          ...
                          receive SMS messages from Eat Authentically regarding
                          my business listing, verification, and account-related
                          updates.
                        </Label>
                      </div>
                      <p className="text-sm">
                        By checking this box, you consent to receive SMS
                        messages from Eat Authentically at the phone number
                        provided. Message frequency varies. Message and data
                        rates may apply. You can reply STOP at any time to
                        unsubscribe or HELP for assistance. Consent is not a
